 ...
 // const {data: session } = useSession();   
  ...
  return (
      <Transition.Root show={open} as={Fragment}>
         <Dialog as="div" className=" z-10 insert-0 overflow-y-auto" onClose ={setOpen}>           
            <div className="flex items-end justify-center min-h-[800px] 
                 sm:min-h-screen pt-4 px-4 pb-28 text-center sm:block sm:p-0">
             <Transition.Child
                      as={Fragment}
              ...
              {/*this is trick the browser into centering modal content */}
              ...
              <Transition.Child
                  ...
                  <div className="mt-5 sm:mt-6">
                          ...
                          disabled:curser-not-allowed hover:disabled:bg-gray-300"
